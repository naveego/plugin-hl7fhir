...
{
    public class InventoryReportEndpointHelper
    {
        private class InventoryReportEndpoint : Endpoint
        {
                ...
                bool isDiscoverRead = false)
            {
                ...
                var uriBuilder = new UriBuilder($"{@"https://server.fire.ly"}/InventoryReport");
        ...
        public static readonly Dictionary<string, Endpoint> InventoryReportEndpoints = new Dictionary<string, Endpoint>
        {
            {
                "InventoryReport", new InventoryReportEndpoint
                {
                    Id = "InventoryReport",
                    Name = "Inventory Report",
                    BasePath = "InventoryReport",
                    AllPath = "InventoryReport",
